...
interface Props {
  ...
  preselectedRelatedType?: string;
  preselectedRelatedId?: string;
  pageTitle: string;
}
...
const form = useForm({
  title: '',
  description: '',
  type: props.preselectedType || 'call',
  status: 'planned',
  start_date: new Date().toISOString().split('T')[0], // Today's date as string
  start_date_obj: new Date(), // Today's date as Date object
  start_time: '',
  start_time_obj: null as Date | null,
  end_date: '',
  end_date_obj: null as Date | null,
  end_time: '',
  end_time_obj: null as Date | null,
  duration: null as number | null,
  location: '',
  related_type: props.preselectedRelatedType || '',
  related_id: props.preselectedRelatedId ? Number(props.preselectedRelatedId) : null,
