...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  props.company &&{
    title: props.company?.name || 'View Company',
    href: 'crm.companies.show',
    params: { id: props.company?.id || 0 }
  },
  {
    title: props.company?.name || 'Edit Company',
    href: 'crm.companies.edit',
...
const form = useForm({
  ...
  custom_fields: props.company.custom_fields || {}
});
...
const submitForm = () => {
  ...
  form.put(route('crm.companies.update', props.company.id), {
    onSuccess: () => {
