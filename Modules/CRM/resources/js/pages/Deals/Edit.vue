<template>
  <AppLayout :breadcrumbs="breadcrumbs">
    <template #page-title>Edit Deal</template>
    <template #page-actions>
      <ActionButton :href="route('crm.deals.show', deal.id)" class="mr-2">
...
const form = useForm({
  ...
  expected_close_date: props.deal.expected_close_date ? new Date(props.deal.expected_close_date) : null,
...
// Methods
const submit = (): void => {
  form.put(route('crm.deals.update', props.deal.id));
};
