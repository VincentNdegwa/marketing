                ...
                <template #content>
                    <form @submit.prevent="submitForm" class="space-y-6">
                        ...
                        <div class="mb-6 rounded-lg bg-gray-50 p-4">
                            <h3 class="mb-4 text-lg font-medium text-gray-900">Required Information</h3>
                            ...
                            <div class="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div class="space-y-2">
                                    ...
                                    <Password
                                        ...
                                        :feedback="true"
                                    />
                                    <small v-if="form.errors.password" class="text-red-900">{{ form.errors.password }}</small>
                                </div>
                            ...
                            <div class="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div class="space-y-2">
                                    <InputText
                                        ...
                                        class="w-full"
                                        :class="{ 'p-invalid': form.errors.business_id }"
                                        disabled
                                    />
                        ...
                        <div class="rounded-lg bg-gray-50 p-4">
                            ...
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div class="space-y-2">
                                    ...
                                    />
                                    <small v-if="form.errors.mobile" class="text-red-900">{{ form.errors.mobile }}</small>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    />
                                    <small v-if="form.errors.job_title" class="text-red-900">{{ form.errors.job_title }}</small>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div class="space-y-2">
                                    ...
                                    />
                                    <small v-if="form.errors.gender" class="text-red-900">{{ form.errors.gender }}</small>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Calendar
                                        ...
                                        dateFormat="yy-mm-dd"
                                        class="w-full"
                                        :class="{ 'p-invalid': form.errors.date_of_birth }"
                                        placeholder="Select date of birth"
                                    />
                                    <small v-if="form.errors.date_of_birth" class="text-red-900">{{ form.errors.date_of_birth }}</small>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div class="space-y-2">
                                    ...
                                    />
                                    <small v-if="form.errors.website" class="text-red-900">{{ form.errors.website }}</small>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    />
                                    <small v-if="form.errors.country" class="text-red-900">{{ form.errors.country }}</small>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div class="space-y-2">
                                    ...
                                    />
                                    <small v-if="form.errors.address_line1" class="text-red-900">{{ form.errors.address_line1 }}</small>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    />
                                    <small v-if="form.errors.address_line2" class="text-red-900">{{ form.errors.address_line2 }}</small>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 grid grid-cols-1 gap-6 md:grid-cols-3">
                                ...
                                <div class="space-y-2">
                                    ...
                                    />
                                    <small v-if="form.errors.postal_code" class="text-red-900">{{ form.errors.postal_code }}</small>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 flex items-center space-x-2">
                                ...
                                <small v-if="form.errors.is_active" class="text-red-900">{{ form.errors.is_active }}</small>
                            </div>
                        </div>

                        <div class="flex justify-end space-x-2">
                            <Button type="button" label="Cancel" outlined @click="router.visit(route('usermanagement.index'))" />
