                ...
                <template #content>
                    <form @submit.prevent="submitForm" class="space-y-6">
                        ...
                        <div class="rounded-lg bg-gray-50 p-4">
                            ...
                            <div class="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div class="space-y-2">
                                    ...
                                    />
                                    <small v-if="form.errors.date_of_birth" class="p-error">{{ form.errors.date_of_birth }}</small>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div class="space-y-2">
                                    ...
                                    />
                                    <small v-if="form.errors.address_line1" class="p-error">{{ form.errors.address_line1 }}</small>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    />
                                    <small v-if="form.errors.address_line2" class="p-error">{{ form.errors.address_line2 }}</small>
                                </div>
                            </div>
                        ...
                        <div class="flex justify-end space-x-2">
                            ...
                            <Button type="submit" label="Update User" icon="pi pi-check" :loading="form.processing" />
                        </div>
                    </form>
                </template>
            </Card>
