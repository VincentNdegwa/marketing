...
namespace Modules\FbSocialite\App\Providers;
...
class FbSocialiteServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'FbSocialite';

    protected string $nameLower = 'fbsocialite';

    protected string $InertiaName = 'fbsocialite::app';
    ...
    protected function registerInertia(): void
    {
        ...
        Inertia::setRootView('fbsocialite::app');
