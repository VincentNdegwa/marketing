...
class PermissionTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $module = 'GoogleSocialite';

        Log::info('Starting GoogleSocialite permission seeding');
        ...
        $permissions = [
            ...
            /*
            [
                'name' => 'googlesocialite.view',
                'display_name' => 'View GoogleSocialite',
                'description' => 'Can view GoogleSocialite module'
            ],
            [
                'name' => 'googlesocialite.create',
                'display_name' => 'Create GoogleSocialite',
                'description' => 'Can create in GoogleSocialite module'
            ],
            [
                'name' => 'googlesocialite.edit',
                'display_name' => 'Edit GoogleSocialite',
                'description' => 'Can edit in GoogleSocialite module'
            ],
            [
                'name' => 'googlesocialite.delete',
                'display_name' => 'Delete GoogleSocialite',
                'description' => 'Can delete in GoogleSocialite module'
            ]
            */
        ];
