        ...
        <div v-if="businesses?.length && businesses.length > 0">
            ...
            >
                ...
                <Column field="website" header="Website" sortable>
                    <template #body="slotProps">
                        <a v-if="slotProps.data.website" :href="slotProps.data.website" target="_blank" class="text-blue-500 hover:underline">
                ...
                <Column field="users" header="Users" style="width: 8rem">
                    <template #body="slotProps">
                        <Tag 
                            :value="slotProps.data.users?.length || 0" 
                            severity="info" 
                        />
                    </template>
                </Column>
                        ...
                        >
                            ...
                            <Column header="Default" style="width: 8rem">
                                <template #body="userSlot">
                                    <Tag 
                                        v-if="userSlot.data.pivot && userSlot.data.pivot.is_default"
                                        value="Default"
                                        severity="success"
                                        icon="pi pi-check"
                                    />
                            ...
                            <Column field="is_active" header="Status" sortable style="width: 8rem">
                                <template #body="userSlot">
                                    <Tag 
                                        :value="userSlot.data.is_active ? 'Active' : 'Inactive'" 
